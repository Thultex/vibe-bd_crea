...
OpenMoji-Grafiken werden zur Laufzeit geladen und sind in Emotronic gegenüber plattformabhängigen Emoji-Zeichen zu bevorzugen, wo Motiv und Darstellung sinnvoll passen. Der Controller `1F3AE` erscheint farbig am direkten Simon-Einstieg, die farbige Videokassette `1F4FC` auf der `R`-Taste im ausgeschalteten Zustand, `1F50D` auf dem Aus-Knopf und der Pokal `1F3C6` in der Score-Vorschau. Text- und ASCII-Fallbacks halten die Anwendung auch bei fehlgeschlagenen Grafik- oder Audiozugriffen bedienbar.
