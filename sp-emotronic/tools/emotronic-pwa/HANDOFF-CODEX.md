...
- `sp-emotronic/tools/emotronic-pwa/Emotronic-v1.71.html` – versionierter Snapshot, nach Änderungen neu erzeugen
...
- Aktuell: **Emotronic v1.71**
- `APP_META.version`: `1.71`
- `APP_META.revision`: `71`
...
```bash
rm -f emotronic-pwa-v1.71.zip
zip -rq emotronic-pwa-v1.71.zip sp-emotronic/tools/emotronic-pwa
unzip -t emotronic-pwa-v1.71.zip
```
