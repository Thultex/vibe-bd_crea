...
- `sp-emotronic/tools/emotronic-pwa/Emotronic-v1.94.html` – versionierter Snapshot, nach Änderungen neu erzeugen
...
- Aktuell: **Emotronic v1.94**
- `APP_META.version`: `1.94`
- `APP_META.revision`: `94`
...
```bash
rm -f emotronic-pwa-v1.94.zip
zip -rq emotronic-pwa-v1.94.zip sp-emotronic/tools/emotronic-pwa
unzip -t emotronic-pwa-v1.94.zip
```
