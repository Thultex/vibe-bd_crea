...
- `sp-emotronic/tools/emotronic-pwa/Emotronic-v1.66.html` – versionierter Snapshot, nach Änderungen neu erzeugen
...
- Aktuell: **Emotronic v1.66**
- `APP_META.version`: `1.66`
- `APP_META.revision`: `66`
...
- Direkt aufeinanderfolgende Duplikate werden nicht erneut gespeichert.
- `R` startet Replay.
...
- Bei `file:` oder Android `content:` nur den portablen `#share=...`-Code kopieren.
...
```bash
rm -f emotronic-pwa-v1.66.zip
zip -rq emotronic-pwa-v1.66.zip sp-emotronic/tools/emotronic-pwa
unzip -t emotronic-pwa-v1.66.zip
```
