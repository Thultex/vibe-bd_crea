...
- `sp-emotronic/tools/emotronic-pwa/Emotronic-v1.83.html` – versionierter Snapshot, nach Änderungen neu erzeugen
...
- Aktuell: **Emotronic v1.83**
- `APP_META.version`: `1.83`
- `APP_META.revision`: `83`
...
```bash
rm -f emotronic-pwa-v1.83.zip
zip -rq emotronic-pwa-v1.83.zip sp-emotronic/tools/emotronic-pwa
unzip -t emotronic-pwa-v1.83.zip
```
