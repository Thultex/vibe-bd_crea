...
- `sp-emotronic/tools/emotronic-pwa/Emotronic-v1.79.html` – versionierter Snapshot, nach Änderungen neu erzeugen
...
- Aktuell: **Emotronic v1.79**
- `APP_META.version`: `1.79`
- `APP_META.revision`: `79`
...
```bash
rm -f emotronic-pwa-v1.79.zip
zip -rq emotronic-pwa-v1.79.zip sp-emotronic/tools/emotronic-pwa
unzip -t emotronic-pwa-v1.79.zip
```
