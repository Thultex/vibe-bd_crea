...
- `sp-emotronic/tools/emotronic-pwa/Emotronic-v1.84.html` – versionierter Snapshot, nach Änderungen neu erzeugen
...
- Aktuell: **Emotronic v1.84**
- `APP_META.version`: `1.84`
- `APP_META.revision`: `84`
...
```bash
rm -f emotronic-pwa-v1.84.zip
zip -rq emotronic-pwa-v1.84.zip sp-emotronic/tools/emotronic-pwa
unzip -t emotronic-pwa-v1.84.zip
```
