...
- `sp-emotronic/tools/emotronic-pwa/Emotronic-v1.75.html` – versionierter Snapshot, nach Änderungen neu erzeugen
...
- Aktuell: **Emotronic v1.75**
- `APP_META.version`: `1.75`
- `APP_META.revision`: `75`
...
```bash
rm -f emotronic-pwa-v1.75.zip
zip -rq emotronic-pwa-v1.75.zip sp-emotronic/tools/emotronic-pwa
unzip -t emotronic-pwa-v1.75.zip
```
