...
- `sp-emotronic/tools/emotronic-pwa/Emotronic-v1.80.html` – versionierter Snapshot, nach Änderungen neu erzeugen
...
- Aktuell: **Emotronic v1.80**
- `APP_META.version`: `1.80`
- `APP_META.revision`: `80`
...
```bash
rm -f emotronic-pwa-v1.80.zip
zip -rq emotronic-pwa-v1.80.zip sp-emotronic/tools/emotronic-pwa
unzip -t emotronic-pwa-v1.80.zip
```
