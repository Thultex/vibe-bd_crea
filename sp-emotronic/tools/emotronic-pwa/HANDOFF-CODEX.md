...
- `sp-emotronic/tools/emotronic-pwa/Emotronic-v1.76.html` – versionierter Snapshot, nach Änderungen neu erzeugen
...
- Aktuell: **Emotronic v1.76**
- `APP_META.version`: `1.76`
- `APP_META.revision`: `76`
...
```bash
rm -f emotronic-pwa-v1.76.zip
zip -rq emotronic-pwa-v1.76.zip sp-emotronic/tools/emotronic-pwa
unzip -t emotronic-pwa-v1.76.zip
```
