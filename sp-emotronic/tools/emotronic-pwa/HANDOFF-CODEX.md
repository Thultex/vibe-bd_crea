...
- `sp-emotronic/tools/emotronic-pwa/Emotronic-v1.81.html` – versionierter Snapshot, nach Änderungen neu erzeugen
...
- Aktuell: **Emotronic v1.81**
- `APP_META.version`: `1.81`
- `APP_META.revision`: `81`
...
```bash
rm -f emotronic-pwa-v1.81.zip
zip -rq emotronic-pwa-v1.81.zip sp-emotronic/tools/emotronic-pwa
unzip -t emotronic-pwa-v1.81.zip
```
