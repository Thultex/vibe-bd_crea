...
- `sp-emotronic/tools/emotronic-pwa/Emotronic-v2.00.html` – versionierter Snapshot, nach Änderungen neu erzeugen
...
- Aktuell: **Emotronic v2.00**
- `APP_META.version`: `2.00`
- `APP_META.revision`: `100`
...
```bash
rm -f emotronic-pwa-v2.00.zip
zip -rq emotronic-pwa-v2.00.zip sp-emotronic/tools/emotronic-pwa
unzip -t emotronic-pwa-v2.00.zip
```
