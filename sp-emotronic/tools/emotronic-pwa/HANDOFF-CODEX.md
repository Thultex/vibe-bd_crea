...
- `sp-emotronic/tools/emotronic-pwa/Emotronic-v2.01.html` – versionierter Snapshot, nach Änderungen neu erzeugen
...
- Aktuell: **Emotronic v2.01**
- `APP_META.version`: `2.01`
- `APP_META.revision`: `101`
...
```bash
rm -f emotronic-pwa-v2.01.zip
zip -rq emotronic-pwa-v2.01.zip sp-emotronic/tools/emotronic-pwa
unzip -t emotronic-pwa-v2.01.zip
```
