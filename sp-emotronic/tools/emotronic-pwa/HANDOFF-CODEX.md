...
- `sp-emotronic/tools/emotronic-pwa/Emotronic-v1.67.html` – versionierter Snapshot, nach Änderungen neu erzeugen
...
- Aktuell: **Emotronic v1.67**
- `APP_META.version`: `1.67`
- `APP_META.revision`: `67`
...
```bash
rm -f emotronic-pwa-v1.67.zip
zip -rq emotronic-pwa-v1.67.zip sp-emotronic/tools/emotronic-pwa
unzip -t emotronic-pwa-v1.67.zip
```
