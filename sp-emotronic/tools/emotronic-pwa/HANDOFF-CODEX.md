...
- `sp-emotronic/tools/emotronic-pwa/Emotronic-v1.69.html` – versionierter Snapshot, nach Änderungen neu erzeugen
...
- Aktuell: **Emotronic v1.69**
- `APP_META.version`: `1.69`
- `APP_META.revision`: `69`
...
```bash
rm -f emotronic-pwa-v1.69.zip
zip -rq emotronic-pwa-v1.69.zip sp-emotronic/tools/emotronic-pwa
unzip -t emotronic-pwa-v1.69.zip
```
