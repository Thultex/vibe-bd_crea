...
- `sp-emotronic/tools/emotronic-pwa/Emotronic-v1.70.html` – versionierter Snapshot, nach Änderungen neu erzeugen
...
- Aktuell: **Emotronic v1.70**
- `APP_META.version`: `1.70`
- `APP_META.revision`: `70`
...
```bash
rm -f emotronic-pwa-v1.70.zip
zip -rq emotronic-pwa-v1.70.zip sp-emotronic/tools/emotronic-pwa
unzip -t emotronic-pwa-v1.70.zip
```
