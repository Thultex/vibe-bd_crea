...
- `sp-emotronic/tools/emotronic-pwa/Emotronic-v1.72.html` – versionierter Snapshot, nach Änderungen neu erzeugen
...
- Aktuell: **Emotronic v1.72**
- `APP_META.version`: `1.72`
- `APP_META.revision`: `72`
...
```bash
rm -f emotronic-pwa-v1.72.zip
zip -rq emotronic-pwa-v1.72.zip sp-emotronic/tools/emotronic-pwa
unzip -t emotronic-pwa-v1.72.zip
```
