...
- `sp-emotronic/tools/emotronic-pwa/Emotronic-v1.77.html` – versionierter Snapshot, nach Änderungen neu erzeugen
...
- Aktuell: **Emotronic v1.77**
- `APP_META.version`: `1.77`
- `APP_META.revision`: `77`
...
```bash
rm -f emotronic-pwa-v1.77.zip
zip -rq emotronic-pwa-v1.77.zip sp-emotronic/tools/emotronic-pwa
unzip -t emotronic-pwa-v1.77.zip
```
