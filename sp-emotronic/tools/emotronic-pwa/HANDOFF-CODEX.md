...
- `sp-emotronic/tools/emotronic-pwa/Emotronic-v1.78.html` – versionierter Snapshot, nach Änderungen neu erzeugen
...
- Aktuell: **Emotronic v1.78**
- `APP_META.version`: `1.78`
- `APP_META.revision`: `78`
...
```bash
rm -f emotronic-pwa-v1.78.zip
zip -rq emotronic-pwa-v1.78.zip sp-emotronic/tools/emotronic-pwa
unzip -t emotronic-pwa-v1.78.zip
```
