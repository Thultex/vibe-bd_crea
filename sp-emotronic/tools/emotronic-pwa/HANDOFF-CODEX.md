...
- `sp-emotronic/tools/emotronic-pwa/Emotronic-v1.88.html` – versionierter Snapshot, nach Änderungen neu erzeugen
...
- Aktuell: **Emotronic v1.88**
- `APP_META.version`: `1.88`
- `APP_META.revision`: `88`
...
```bash
rm -f emotronic-pwa-v1.88.zip
zip -rq emotronic-pwa-v1.88.zip sp-emotronic/tools/emotronic-pwa
unzip -t emotronic-pwa-v1.88.zip
```
