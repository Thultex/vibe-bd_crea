...
- `sp-emotronic/tools/emotronic-pwa/Emotronic-v1.68.html` – versionierter Snapshot, nach Änderungen neu erzeugen
...
- Aktuell: **Emotronic v1.68**
- `APP_META.version`: `1.68`
- `APP_META.revision`: `68`
...
```bash
rm -f emotronic-pwa-v1.68.zip
zip -rq emotronic-pwa-v1.68.zip sp-emotronic/tools/emotronic-pwa
unzip -t emotronic-pwa-v1.68.zip
```
