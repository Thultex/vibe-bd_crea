...
- `sp-emotronic/tools/emotronic-pwa/Emotronic-v1.73.html` – versionierter Snapshot, nach Änderungen neu erzeugen
...
- Aktuell: **Emotronic v1.73**
- `APP_META.version`: `1.73`
- `APP_META.revision`: `73`
...
```bash
rm -f emotronic-pwa-v1.73.zip
zip -rq emotronic-pwa-v1.73.zip sp-emotronic/tools/emotronic-pwa
unzip -t emotronic-pwa-v1.73.zip
```
