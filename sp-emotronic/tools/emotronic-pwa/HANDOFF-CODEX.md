...
- `sp-emotronic/tools/emotronic-pwa/Emotronic-v1.74.html` – versionierter Snapshot, nach Änderungen neu erzeugen
...
- Aktuell: **Emotronic v1.74**
- `APP_META.version`: `1.74`
- `APP_META.revision`: `74`
...
```bash
rm -f emotronic-pwa-v1.74.zip
zip -rq emotronic-pwa-v1.74.zip sp-emotronic/tools/emotronic-pwa
unzip -t emotronic-pwa-v1.74.zip
```
