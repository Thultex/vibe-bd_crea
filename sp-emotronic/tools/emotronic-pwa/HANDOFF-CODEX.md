...
- `sp-emotronic/tools/emotronic-pwa/Emotronic-v1.97.html` – versionierter Snapshot, nach Änderungen neu erzeugen
...
- Aktuell: **Emotronic v1.97**
- `APP_META.version`: `1.97`
- `APP_META.revision`: `97`
...
```bash
rm -f emotronic-pwa-v1.97.zip
zip -rq emotronic-pwa-v1.97.zip sp-emotronic/tools/emotronic-pwa
unzip -t emotronic-pwa-v1.97.zip
```
