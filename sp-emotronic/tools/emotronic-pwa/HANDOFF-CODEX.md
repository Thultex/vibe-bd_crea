...
- `sp-emotronic/tools/emotronic-pwa/Emotronic-v1.82.html` – versionierter Snapshot, nach Änderungen neu erzeugen
...
- Aktuell: **Emotronic v1.82**
- `APP_META.version`: `1.82`
- `APP_META.revision`: `82`
...
```bash
rm -f emotronic-pwa-v1.82.zip
zip -rq emotronic-pwa-v1.82.zip sp-emotronic/tools/emotronic-pwa
unzip -t emotronic-pwa-v1.82.zip
```
