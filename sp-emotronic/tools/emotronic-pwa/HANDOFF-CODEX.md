...
- `sp-emotronic/tools/emotronic-pwa/Emotronic-v1.87.html` – versionierter Snapshot, nach Änderungen neu erzeugen
...
- Aktuell: **Emotronic v1.87**
- `APP_META.version`: `1.87`
- `APP_META.revision`: `87`
...
```bash
rm -f emotronic-pwa-v1.87.zip
zip -rq emotronic-pwa-v1.87.zip sp-emotronic/tools/emotronic-pwa
unzip -t emotronic-pwa-v1.87.zip
```
